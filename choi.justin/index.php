...
<div class="view-window display-flex flex-align-center flex-justify-center" style="background-image:url(product/images/main.jpg)">
         <h2>The minimal products for designers</h2>
   </div>


   <div class="container">
      <article id="article1">
         <h4>THE HOME FOR MINIMALISM PRODUCTS</h4>
         <div class="article-body">
            <h4>Lorem ipsum dolor sit, amet consectetur adipisicing elit. At rem mollitia cupiditate consectetur dolorem, quaerat. Nihil sunt ullam harum ex id quam ipsum, amet molestiae.</h4>
         </div>
      </article>
   </div>
   <h2> OUR FAVORITES</h2>
