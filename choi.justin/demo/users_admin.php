...
<div class="grid gap">
         ...
         <div class="col-xs-12 col-md-6">
          <div class="form-control">
            <label for="example3" class="form-label">State/Zip code</label>
            <input id="example3" type="text" placeholder="State/Zip code" class="form-input">
          </div>
        </div>
      </div>
      <div class="grid gap">
          <div class="col-xs-12 col-md-6">
           <div class="form-control">
            <label for="example3" class="form-label">User ID</label>
            <input id="example3" type="text" placeholder="User ID" class="form-input">
            </div>
          </div>
         <div class="col-xs-12 col-md-6">
          <div class="form-control">
            <label for="example3" class="form-label">Password</label>
            <input id="example3" type="text" placeholder="Password" class="form-input">
          </div>
        </div>
      </div>
       <div class="grid gap">
       ...
       <div class="center" style="margin-top: 4em"><a href="#" class="button2">Submit</a>
       <a href="#" class="button2">Save</a>
       </div>
HTML;
}
